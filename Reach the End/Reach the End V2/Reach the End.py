    ...
    if main_menu == "s" :
        while True : 
            ...
            if start_menu in Maps.keys() :
                start_game(configurations[start_menu], Maps[start_menu], view_distance)
            elif start_menu == "c" :
                for config_key, Map in Maps.items() :
                    start_game(configurations[config_key], Map, view_distance)
            elif start_menu == "r" :
